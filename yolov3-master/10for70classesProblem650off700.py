...
readingTheTextFile = open("F:\\yolov3-master\\class number class name QID modifiedd.txt", "r")
allQIDs=[]
justWantObjectNames=[]
...
wikidataURL=['http://www.wikidata.org/entity/'+s for s in allQIDs]
# print(wikidataURL)

excelQID=pd.DataFrame(data={"object name":justWantObjectNames,"all_QIDs":allQIDs,"wikidata_URL":wikidataURL})
excelQID.to_csv("F:\\yolov3-master\\excels\\excelQID.csv",sep=',',index=False)


hasontheleft=pd.DataFrame(data={"has on the left":justWantObjectNames,"all_QIDs":allQIDs,"URI has on the left":wikidataURL})
hasontheleft.to_csv("F:\\yolov3-master\\excels\\hasontheleft.csv",sep=',',index=False)

hasontheright=pd.DataFrame(data={"has on the right":justWantObjectNames,"all_QIDs":allQIDs,"URI has on the right":wikidataURL})
hasontheright.to_csv("F:\\yolov3-master\\excels\\hasontheright.csv",sep=',',index=False)

hasonthetop=pd.DataFrame(data={"has on the top":justWantObjectNames,"all_QIDs":allQIDs,"URI has on the top":wikidataURL})
hasonthetop.to_csv("F:\\yolov3-master\\excels\\hasonthetop.csv",sep=',',index=False)

hasonthebottom=pd.DataFrame(data={"has on the bottom":justWantObjectNames,"all_QIDs":allQIDs,"URI has on the bottom":wikidataURL})
hasonthebottom.to_csv("F:\\yolov3-master\\excels\\hasonthebottom.csv",sep=',',index=False)

hasinthecenter=pd.DataFrame(data={"has in the center":justWantObjectNames,"all_QIDs":allQIDs,"URI has on the center":wikidataURL})
hasinthecenter.to_csv("F:\\yolov3-master\\excels\\hasinthecenter.csv",sep=',',index=False)

readingTheTextFile2 = open("F:\\yolov3-master\\class number class name QID modifiedd.txt", "r")
allQIDs2=[]
...
print(df)
df.to_csv('F:\\yolov3-master\\excels\\imageNameBoundingBoxesObjectNameXYcenter.csv',
          index=False)


df4 = pd.read_csv(
    'F:\\yolov3-master\\excels\\imageNameBoundingBoxesObjectNameXYcenter.csv')
...
df6.to_csv(
    'F:\\yolov3-master\\excels\\imageNameBoundingBoxesObjectNameXYcenterImageDim.csv',
...
print(ddf)
ddf.to_csv("f:\\yolov3-master\\excels\\imageHasOnLeftRightCenterTopBotto.csv",sep=',',index=False)


df7 = pd.read_csv('f:\\yolov3-master\\excels\\imageHasOnLeftRightCenterTopBotto.csv')
df8 = pd.read_csv('f:\\yolov3-master\\excels\\excelQID.csv')

df9=df7.merge(df8, on='object name', how='left')
df9.to_csv('f:\\yolov3-master\\excels\\imageHasOnLeftRightCenterTopBott.csv', encoding='utf-8', index=False)


df10 = pd.read_csv('f:\\yolov3-master\\excels\\imageHasOnLeftRightCenterTopBott.csv')
df11 = pd.read_csv('f:\\yolov3-master\\excels\\hasontheleft.csv')

df12=df10.merge(df11, on='has on the left', how='left')
df12.to_csv('f:\\yolov3-master\\excels\\hasontheleftimageHasOnLeftRightCenterTopBott.csv', encoding='utf-8', index=False)


df13 = pd.read_csv('f:\\yolov3-master\\excels\\hasontheleftimageHasOnLeftRightCenterTopBott.csv')
df14 = pd.read_csv('f:\\yolov3-master\\excels\\hasontheright.csv')

df15=df13.merge(df14, on='has on the right', how='left')
df15.to_csv('f:\\yolov3-master\\excels\\hasontherightimageHasOnLeftRightCenterTopBottom.csv', encoding='utf-8', index=False)


df16 = pd.read_csv('f:\\yolov3-master\\excels\\hasontherightimageHasOnLeftRightCenterTopBottom.csv')
df17 = pd.read_csv('f:\\yolov3-master\\excels\\hasonthetop.csv')

df18=df16.merge(df17, on='has on the top', how='left')
df18.to_csv('f:\\yolov3-master\\excels\\hasonthetopimageHasOnLeftRightCenterTopBottom.csv', encoding='utf-8', index=False)

df19 = pd.read_csv('f:\\yolov3-master\\excels\\hasonthetopimageHasOnLeftRightCenterTopBottom.csv')
df20 = pd.read_csv('f:\\yolov3-master\\excels\\hasonthebottom.csv')

df21=df19.merge(df20, on='has on the bottom', how='left')
df21.to_csv('f:\\yolov3-master\\excels\\hasonthebottomimageHasOnLeftRightCenterTopBottom.csv', encoding='utf-8', index=False)

df22 = pd.read_csv('f:\\yolov3-master\\excels\\hasonthebottomimageHasOnLeftRightCenterTopBottom.csv')
df23 = pd.read_csv('f:\\yolov3-master\\excels\\hasinthecenter.csv')

df24=df22.merge(df23, on='has in the center', how='left')
df24.to_csv('f:\\yolov3-master\\excels\\hasinthecenterimageHasOnLeftRightCenterTopBottom.csv', encoding='utf-8', index=False)


df25 = pd.read_csv('f:\\yolov3-master\\excels\\hasinthecenterimageHasOnLeftRightCenterTopBottom.csv')

df26=df25.drop(['X1','Y1','X2','Y2','X-centre', 'Y-centre','dimention','Y-Image Dimentions','X-Image Dimentions','all_QIDs_x','all_QIDs_y','all_QIDs_x.1','all_QIDs_y.1','all_QIDs_x.1.1','all_QIDs_y.1.1','wikidata_URL','has on the left','has on the right','has on the top','has on the bottom','has in the center'], axis = 1)
...
df26['mpageid'] = 'http://commons.wikimedia.org/entity/' + df26['mpageid'].astype(str)
...
df26.to_csv('f:\\yolov3-master\\excels\\imageHasOnLeftRightCenterTopBottom.csv', encoding='utf-8', index=False)
df26.to_csv('f:\\data2rdf-master\\src\\main\\resources\\imageHasOnLeftRightCenterTopBottom.csv', encoding='utf-8', index=False)
...
# F:\data2rdf-master
os.chdir(dir_path)
subprocess.run('java -jar data2rdf-1.0-SNAPSHOT.jar -f eu.qanswer.data2rdf.mappings.imageannotation.ObjectPosition -o outputfile.nt --file f:\yolov3-master\excels\imageHasOnLeftRightCenterTopBottom.csv ', shell=True)
dir_path = 'f:\\data2rdf-master\\target'
# F:\data2rdf-master
os.chdir(dir_path)
